...
from model_wrapper import LLaVA
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/home/zengxiyu24/RobustVLM/llava-v1.5-7b", help="LLaVA模型路径")
    ...
    matrix_path = os.path.join(args.svd_path, "steering_matrices_llava.pt")
    components_path = os.path.join(args.svd_path, "svd_components_llava.pt")
