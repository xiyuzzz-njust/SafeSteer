...
from qwen_wrapper import Qwen2VL
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/home/zengxiyu24/Qwen2.5-VL-7B-Instruct", help="LLaVA模型路径")
    ...
    model_wrapper = Qwen2VL(args.model_path)
    model_name = "qwen2_5"
    ...
    print(f"🔍 加载数据集，共计 {len(dataset_for_analysis)} 条样本...")

    matrix_path = os.path.join(args.svd_path, "steering_matrices_qwen2_5.pt")
    components_path = os.path.join(args.svd_path, "svd_components_qwen2_5.pt")
